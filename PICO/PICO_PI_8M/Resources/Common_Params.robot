...
${TERMINATOR}    root@pico-imx8mm:~#
${SERIAL_PORT}    /dev/ttyUSB0
${ETH_INF}    eth0
${LOGIN_PROMPT}    pico-imx8mm login:
${LOGIN_ACC}    root
...
#Test Images
${TEST_IMAGE_BMAP}        ./imx-image-full-pico-imx8mm.rootfs-20241226173732.wic.bmap
${TEST_IMAGE}             ./imx-image-full-pico-imx8mm.rootfs-20241226173732.wic.bz2 
${NXP_DEV_NAME}           NXP Semiconductors USB download gadget
