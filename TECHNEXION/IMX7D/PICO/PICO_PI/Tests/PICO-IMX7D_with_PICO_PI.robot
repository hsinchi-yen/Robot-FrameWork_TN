...
=========================================================================
 ...
 DUT               : PICO_IMX7D _ PICO_PI
 Purpose           : Regresson Test for Essential Functionality 
 Script name       : PICO-IMX7D_with_PICO_PI.robot
 Author            : lancey 
 Date created      : 20250117
=========================================================================
*** Settings ***
Library           Collections
Library           String
...
Case TNPT-25
    [Tags]              Test A-System and Function    Power
...
Case TNPT-146 and TNPT-137
    #Refer to Power_Cycle_test.robot
    #The Case also cover the TNPT-137 - Boot from SD when boot config is set to boot from SDCARD.
...
Case TNPT-433
    [Tags]              Test A-System and Function
    [Documentation]     CLIX SDCARD Function 
    SDCARD Read And Write Test 
...
Case TNPT-34 and TNPT-35 and TNPT 36
    [Tags]              Test A-System and Function    Periperials
    #This test only cover Pop noise test of TNPT 35 and TNPT36, the hotplug and hearing test is human intervention required.
    [Documentation]     Audio Jack / Audio pop Noise test
    Audio Jack Test
    

Case TNPT-856
    [Tags]              Test A-System and Function    Periperials
    [Documentation]     Bluetooth A2DP Source/Sink profile - PipeWire
    Bluetooth Speaker Connect
    Reset Input Buffer
    Reset Output Buffer
    Kernel Check Play
