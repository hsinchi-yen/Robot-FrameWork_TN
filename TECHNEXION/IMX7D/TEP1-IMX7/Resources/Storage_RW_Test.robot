...
#sd mmc in IMX7D mmc0
${SDCARD_LOC}=       /dev/mmcblk0
${SDCARD_BUSINFO}=   /sys/kernel/debug/mmc0/ios 
...
Get USB Device Info
    [Arguments]    ${location}
    SerialLibrary.Write Data    udevadm info --query=all --name=${location} | grep "ID_"${\n}
    Sleep    2
...
SDCARD Sdio Bus Info Check
    ...
    Run Keyword And Continue On Failure    Should Contain    ${sd_businfo_log}    0 (3.30 V)
