...
=========================================================================
 ...
 DUT               : EDM_IMX93 _ EDM_WB
 Purpose           : Regresson Test for Essential Functionality 
 Script name       : EDM-IMX93_with_EDM_WB.robot
 Author            : RaymondC
 Date created      : 202407/30
=========================================================================
*** Settings ***
Library           Collections
Library           String
...
Case TNPT-11 
    [Tags]              Test A-System and Function    
    [Documentation]     Giga LAN1 - Ethernet Interface UP/DOWN
    LAN1 Interface DOWN Test
    LAN1 Interface UP Test
Case TNPT-371 
    [Tags]              Test A-System and Function    
    [Documentation]     Giga LAN2 - Ethernet Interface UP/DOWN
...
Case TNPT-24    
    ...
    Sleep    2
    LAN2 Ethernet Interface Check

Case TNPT-12    
    [Tags]              Test A-System and Function       ping
    [Documentation]     Giga LAN1 - DHCP, ICMP Ping (IPv4)
    LAN1 IPv4 Ping Test
Case TNPT-372    
    [Tags]              Test A-System and Function       ping
    [Documentation]     Giga LAN2 - DHCP, ICMP Ping (IPv4)
    LAN2 IPv4 Ping Test
Case TNPT-13    
    [Tags]              Test A-System and Function       
    [Documentation]     Giga LAN1 - DHCP, ICMP Ping (IPv6)
    LAN1 IPv6 Ping Test
Case TNPT-373    
    [Tags]              Test A-System and Function       
    [Documentation]     Giga LAN2 - DHCP, ICMP Ping (IPv6)
    LAN2 IPv6 Ping Test
Case TNPT-14 and TNPT 31
    [Tags]              Test A-System and Function      
    [Documentation]     Giga LAN1 - Auto-Negotiation 10/100/1000 Base-T / LED indicators
    LAN1 Set 10Mb Test
    LAN1 Set 100Mb Test
    LAN1 Set 1000Mb Test
Case TNPT-374 and TNPT 380
    [Tags]              Test A-System and Function      
    [Documentation]     Giga LAN2 - Auto-Negotiation 10/100/1000 Base-T / LED indicators
    LAN2 Set 10Mb Test
    LAN2 Set 100Mb Test
    LAN2 Set 1000Mb Test
Case TNPT-16
    [Tags]              Test A-System and Function     eth
    [Documentation]     Giga LAN1 - TX Ethernet performance (upload)    
    LAN1 ETH Iperf3 Tx Test
Case TNPT-376
    [Tags]              Test A-System and Function     eth
    [Documentation]     Giga LAN2 - TX Ethernet performance (upload)    
    LAN2 ETH Iperf3 Tx Test
Case TNPT-367
    [Tags]              Test A-System and Function     eth
    [Documentation]     Giga LAN1 - RX Ethernet performance (Download)    
    LAN1 ETH Iperf3 Rx Test
Case TNPT-671
    [Tags]              Test A-System and Function     eth
    [Documentation]     Giga LAN2 - RX Ethernet performance (Download)    
    LAN2 ETH Iperf3 Rx Test

Case TNPT-368
    [Tags]              Test A-System and Function     eth
    [Documentation]     Giga LAN1 - TX/RX Ethernet performance (Bi-Direction)    
    LAN1 ETH Iperf3 Bidirection Test
Case TNPT-672
    [Tags]              Test A-System and Function     eth
    [Documentation]     Giga LAN2 - TX/RX Ethernet performance (Bi-Direction)    
    LAN2 ETH Iperf3 Bidirection Test
Case TNPT-18
    [Tags]              Test A-System and Function   wol
    [Documentation]     Giga LAN1 - Wake on LAN 
    ${dut_mac}=    LAN1 Get DUT MAC
    LAN1 Set Wake On Lan and Set DUT to Sleep
    LAN1 Wake Up DUT via Ethernet Magic Packet    ${dut_mac}
    Sleep    5
    Run Keyword And Continue On Failure    LAN1 IPv4 Ping Test
...
Case TNPT-379
    [Tags]              Test A-System and Function   wol
    [Documentation]     Giga LAN2 - Wake on LAN 
    ${dut_mac}=    LAN2 Get DUT MAC
    LAN2 Set Wake On Lan and Set DUT to Sleep
    LAN2 Wake Up DUT via Ethernet Magic Packet    ${dut_mac}
    Sleep    8
    Run Keyword And Continue On Failure    LAN2 IPv4 Ping Test
    #solve the know issue - after wake on Lan
    LAN2 Down Workaround
    Sleep    8
    Run Keyword And Continue On Failure    LAN2 IPv4 Ping Test
Case TNPT-142
    [Tags]              Test A-System and Function   
...
Case TNPT-177 
    [Tags]              Test A-System and Function    stress  
    [Documentation]     WIFI Stress 12H TX
    Start WIFI stress

Case TNPT-386
    [Tags]              Test A-System and Function    stress  
    [Documentation]     LAN Stress 12H Bidir (LAN1/LAN2)
...
Case TNPT-185
    [Tags]              Test A-System and Function    stress  
    [Documentation]     WLAN Interface UP DOWN Stress 500 times
    
    WLAN Interface UP DOWN 500 times

Case TNPT-167
    [Tags]              Test A-System and Function    stress  
    [Documentation]     CPU(50%) + Memory(5%) + GPU(5%) + Wi-Fi Stress Test (12 hours)
