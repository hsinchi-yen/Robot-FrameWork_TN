...
StressNG Command
    ...
    IF    ${CPU_Num} == 6 
        ...
        SerialLibrary.Write Data    taskset 0x10 stress-ng --cpu ${CPU_Num} --io 1 --timeout ${Duration} &${\n}
        SerialLibrary.Write Data    taskset 0x20 stress-ng --cpu ${CPU_Num} --io 1 --timeout ${Duration} &${\n}
    ELSE IF   ${CPU_Num} == 4 
