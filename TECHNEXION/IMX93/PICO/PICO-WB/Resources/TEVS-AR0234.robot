...
Run GST Command 
    ...
    SerialLibrary.Write Data     gst-launch-1.0 v4l2src device=/dev/video0 ! 'video/x-raw,width=1280,height=720,format=YUY2' ! waylandsink &${\n}
    Sleep    1
    # ${log}=    SerialLibrary.Read All Data    UTF-8
    # Run Keyword And Continue On Failure    Should Not Contain    ${log}    ERROR
