...
=========================================================================
 ...
 DUT               : PICO_IMX93 _ PICO_WB
 Purpose           : Regresson Test for Essential Functionality 
 Script name       : PICO-IMX93_with_PICO_WB.robot
 Author            : RaymondC
 Date created      : 202412/03
=========================================================================
*** Settings ***
Library           Collections
Library           String
...
Case TNPT-386
    [Tags]              Test A-System and Function    stress  
    [Documentation]     LAN Stress 12H Bidir (LAN1)
...
Case TNPT-167 
    [Tags]              Test A-System and Function    stress  
    [Documentation]     CPU_MEM_GPU_WIFI_Stress
