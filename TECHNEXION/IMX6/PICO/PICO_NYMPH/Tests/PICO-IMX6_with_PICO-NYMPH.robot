...
=========================================================================
 ...
 DUT               : PICO_IMX6 _ PICO-NYMPH
 Purpose           : Regresson Test for Essential Functionality 
 Script name       : PICO_IMX6_with_PICO-NYMPH.robot
 Author            : RaymondC
 Date created      : 202408/08
=========================================================================
*** Settings ***
Library           Collections
Library           String
...
Case TNPT-128
    [Tags]              Test A-System and Function    mem
    [Documentation]     Memory performance
    Memory Benchmark
...
Case TNPT-517
    ...
    [Documentation]     Camera-Test TEVI_OV5640
    Camera-TEVI_OV5640

Case TNPT-210
    [Tags]              Test A-System and Function    
    [Documentation]     Dual Display (HDMI + LVDS)
    HDMI+LVDS
