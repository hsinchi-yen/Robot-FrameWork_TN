...
CPU Info
   ...
   @{lines}=    Split To Lines    ${info}
    ...
    ${CPUinfo1}=    Get From List    ${lines}    6
    ${CPUinfo2}=    Get From List    ${lines}    7
    ${CPUinfo3}=    Get From List    ${lines}    8
    ${CPUinfo4}=    Get From List    ${lines}    9
    ${CPUinfo5}=    Get From List    ${lines}    10
    ${CPUinfo6}=    Get From List    ${lines}    11
    Log To Console    \n================CPU Info=================    
