...
Memory Info
   ...
   @{lines}=    Split To Lines    ${info}
    ...
    ${Meminfo1}=    Get From List    ${lines}    6
    ${Meminfo2}=    Get From List    ${lines}    7
    ${Meminfo3}=    Get From List    ${lines}    8
    ${Meminfo4}=    Get From List    ${lines}    9
    ${Meminfo5}=    Get From List    ${lines}    10
