...
class RobotTestRunner:
    def __init__(self, root):
        ...
        self.ssh.connect("10.88.88.214", username='root', password='', allow_agent=False, look_for_keys=False)
    ...
    def create_widgets(self):
        ...
        # DCOUT1 button
        self.dcout1_button = tk.Button(self.right_frame, text=DCOUT1_button_text, font=("Arial", 8), width=8, bg=DCOUT1_button_color, command=self.toggle_dcout1)
        self.dcout1_button.pack(pady=5)
        # DCOUT2 button
        self.dcout2_button = tk.Button(self.right_frame, text=DCOUT2_button_text, font=("Arial", 8), width=8, bg=DCOUT2_button_color, command=self.toggle_dcout2)
    ...
    def toggle_dcout1(self):
        ...
        if current_state == 'OFF':
            ...
            self.ssh_command('gpioset gpiochip2 16=1')
        else:
            self.dcout1_button.config(text='DCOUT1 OFF',bg='red')
            self.ssh_command('gpioset gpiochip2 16=0')
