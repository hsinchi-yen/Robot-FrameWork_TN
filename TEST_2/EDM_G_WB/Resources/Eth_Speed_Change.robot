...
${10M_LINK_UP_EVENT}    Link is Up - 10Mbps
${100M_LINK_UP_EVENT}    Link is Up - 100Mbps
${1G_LINK_UP_EVENT}    Link is Up - 1Gbps

*** Keywords ***
Set 10Mb Test
    SerialLibrary.Write Data    ethtool -s ${ETH_INF} speed 10 duplex full${\n}
    SerialLibrary.Write Data    dmesg -T | grep "${10M_LINK_UP_EVENT}"${\n}
    Sleep    5
    ${set_10_log}=    SerialLibrary.Read All Data     UTF-8   
    Log    ${set_10_log}
    Should Contain    ${set_10_log}    ${10M_LINK_UP_EVENT}
...
Set 100Mb Test
    ...
    SerialLibrary.Write Data    dmesg -T | grep "${100M_LINK_UP_EVENT}"${\n}
    Sleep    5
    ${set_100_log}=    SerialLibrary.Read All Data     UTF-8   
    Log    ${set_100_log}
    Should Contain    ${set_100_log}    ${100M_LINK_UP_EVENT}
    SerialLibrary.Write Data    ethtool ${ETH_INF} | grep Speed${\n}
    Sleep    2
    ${set_100_log}=    SerialLibrary.Read All Data     UTF-8  
...
Set 1000Mb Test
    ...
    SerialLibrary.Write Data    dmesg -T | grep "${1G_LINK_UP_EVENT}"${\n}
    Sleep    5
    ${set_1000_log}=    SerialLibrary.Read All Data     UTF-8   
    Log    ${set_1000_log}
    Should Contain    ${set_1000_log}    ${1G_LINK_UP_EVENT}
    SerialLibrary.Write Data    ethtool ${ETH_INF} | grep Speed${\n}
    Sleep    2
    ${set_1000_log}=    SerialLibrary.Read All Data     UTF-8  
